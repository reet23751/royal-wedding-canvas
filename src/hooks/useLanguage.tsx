...
const TRANSLATIONS: Record<Language, Record<string, string>> = {
  en: {
    ...
    "rsvp.editRsvp": "Edit RSVP",
    "rsvp.cancel": "Cancel",
    "rsvp.submittedMessage": "Your details have been saved.",
  ...
  bn: {
    ...
    "rsvp.submitRsvp": "জমা দিন",
    "rsvp.editRsvp": "পরিবর্তন করুন",
    "rsvp.cancel": "বাতিল করুন",
    "rsvp.submittedMessage": "আপনার তথ্য সংরক্ষিত হয়েছে।",
  ...
  hi: {
    ...
    "rsvp.submitRsvp": "सबमिट करें",
    "rsvp.editRsvp": "संपादित करें",
    "rsvp.cancel": "रद्द करें",
    "rsvp.submittedMessage": "आपका विवरण सहेज लिया गया है।",
  ...
  mix: {
    ...
    "rsvp.editRsvp": "Edit RSVP",
    "rsvp.cancel": "Cancel",
    "rsvp.submittedMessage": "Aapki details save ho gayi hain.",
    "rsvp.thanks": "Thank You {guestName}!",
